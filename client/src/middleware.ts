 ...
 * @param context - Astro context object containing request information
 * @param next - Function to continue to next middleware or route handler
 * @returns Response from API server or error response
 */
